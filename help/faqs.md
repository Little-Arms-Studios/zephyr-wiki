...
Login to https://zephyr-sim.com/login
{% endstep %}

{% step %}
### Open the Dashboard

If you are not on your management page, click the Dashboard button in the top right.
{% endstep %}

{% step %}
### Open Manage

Once you are on the Dashboard, click Manage on the left.
{% endstep %}

{% step %}
### Create a course if needed

If you haven't created a course yet, you need to do that first. If you've created a course skip to step 8.
{% endstep %}
...
Fill out the fields and click Create again.
{% endstep %}
...
Select the course you wish for the student(s) to be assigned to.
{% endstep %}

{% step %}
### Enter student emails

Enter the email(s) of your student(s), separated by commas if there are multiple.
{% endstep %}

{% step %}
### Send invitations

Click Invite and they will be sent invitation emails that will automatically tie them to your institution and course when they complete it.
{% endstep %}
{% endstepper %}
...
Click the button with the 3 dots to the right of the "Launch" button on the Zephyr tab to access the options.
{% endstep %}

{% step %}
### Run Scan and Repair

Select "Scan and Repair" This will run for a moment and clear out corrupted files. Wait for the process to finish.
{% endstep %}

{% step %}
### Launch Zephyr

Once it completes, you should be able to click the Launch button and use Zephyr as expected.
{% endstep %}
{% endstepper %}
