...
* On Mac, when pressing the green "zoom" button in the application's toolbar, Mac will override the resolution settings to a much higher resolution than intended. Troubleshooting details can be found here: [mac-zoom-button-performance-issue.md](../../../troubleshooting/mac-zoom-button-performance-issue.md "mention")
